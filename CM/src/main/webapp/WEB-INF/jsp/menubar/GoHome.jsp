...
<link rel='canonical' href='http://themes.themegoods2.com/grandrestaurant/' />
<link rel='shortlink' href='http://themes.themegoods2.com/grandrestaurant/' />
...
<script type="text/javascript" src="../js/primium.js"></script>
...
<body class="home page page-id-2 page-template-default">
                ...
                <ul class="flickr">
                  ...
                  <li><a class="img_frame" target="_blank"
                    ...
                    title="rainy day baking- blueberry cake"><img
                      ...
                      alt="rainy day baking- blueberry cake" width="75"
                      height="75" /></a></li>
                  <li><a class="img_frame" target="_blank"
                  ...
                  <ul id="main_menu" class="nav">
                    ...
                    <li id="menu-item-2817"
                      ...
                      <ul class="sub-menu">
                        <li id="menu-item-2827"
                          class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2827"><a
                          href="../customer/list.do" onclick="onAdmin()">회원 현황</a></li>
                        <li id="menu-item-2831"
                          class="menu-item menu-item-type-post_type menu-item-object-page menu-item-2831"><a
                          href="#">Menu0402</a></li>
                        <li id="menu-item-2838"
            ...
            <div id="baner">
              ...
              <div id="view_box">
                <ul class="gallery clearfix">
                  <li class="view1"><a href="#"><img
                      src="../img/love01.jpg" width="1245px" height="483px"
                      alt="love01" /></a></li>
                  <li><a href="#"><img src="../img/love02.jpg"
                      width="1245px" height="483px" alt="love02" /></a></li>

                  <li><a href="#"><img src="../img/love04.jpg"
                      width="1245px" height="483px" alt="love03" /></a></li>
              ...
              <p id="left">
                <img
                  src="http://www.timemecca.com/Design/new/images/premium/pb_left_off.png"
                  onmouseover="this.src='http://www.timemecca.com/Design/new/images/premium/pb_left_on.png'"
                  onmouseout="this.src='http://www.timemecca.com/Design/new/images/premium/pb_left_off.png'"
                  alt="left" />
              </p>
              <p id="right">
                <img
                  src="http://www.timemecca.com/Design/new/images/premium/pb_right_off.png"
                  onmouseover="this.src='http://www.timemecca.com/Design/new/images/premium/pb_right_on.png'"
                  onmouseout="this.src='http://www.timemecca.com/Design/new/images/premium/pb_right_off.png'"
                  alt="right" />
              </p>
  ...
  <div class="open_table_field">
    <span class="glyphicon glyphicon-search">찾을 사람</span>
    <label for="search" class="hidden" ></label>
    <form id='form' action='../customer/search.do' method='post' enctype="multipart/form-data">
    ...
    </select> <input id='txtselectage' type="hidden" name='age' size='10'> 
    <select name="selectaddress">
      ...
      <button type='submit' class="btn btn-default" onclick="getSelectValue(this.form);"><span class="glyphicon glyphicon-search"></span>검색</button>
